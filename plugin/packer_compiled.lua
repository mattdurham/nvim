...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/Users/mdurham/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["cmp-path"] = {
    loaded = true,
    path = "/Users/mdurham/.local/share/nvim/site/pack/packer/start/cmp-path",
  ...
  nerdtree = {
    loaded = true,
    path = "/Users/mdurham/.local/share/nvim/site/pack/packer/start/nerdtree",
  ...
  ["vim-calc"] = {
    ...
    url = "https://github.com/theniceboy/vim-calc"
  },
  ["vim-code-dark"] = {
    loaded = true,
    path = "/Users/mdurham/.local/share/nvim/site/pack/packer/start/vim-code-dark",
